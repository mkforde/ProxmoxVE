...
# upstream   https://github.com/mkforde/ProxmoxVE.git (fetch)
# upstream   https://github.com/mkforde/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/mkforde/ProxmoxVE"
echo ""
