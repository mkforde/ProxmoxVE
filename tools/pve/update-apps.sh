...
source <(curl -fsSL https://raw.githubusercontent.com/mkforde/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/mkforde/ProxmoxVE/main/ct/${service}.sh)
